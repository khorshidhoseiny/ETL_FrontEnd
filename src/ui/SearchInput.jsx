...
function SearchInput() {
  return (
    <div className="flex items-center border border-gray-300 rounded-xl  relative max-w-47.5 leading-7">
      <input
        className="w-full h-10 leading-7 px-4 pl-10 border-2 border-transparent rounded-xl outline-none bg-white text-black transition-all duration-300 ease-in-out focus:outline-none
